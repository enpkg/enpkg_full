...
path_data = os.path.join(os.path.dirname(os.getcwd()), "enpkg_full/monolith/downloads/") #"..." enter your pathname to the downloaded file
...
def gnps_spectral_fetcher() -> None:
    ...
    downloader.download(GNPS_CLEANED_SPECTRA_URL, "monolith/downloads/cleaned_gnps_library.mgf")
