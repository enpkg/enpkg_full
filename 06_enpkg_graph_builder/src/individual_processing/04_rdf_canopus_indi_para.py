            ...
            if sirius_version == 4:
                ...
                try:
                    ...
                    canopus_annotations = pd.read_csv(
                        canopus_npc_path, encoding="utf-8"
                    )
                    ...
                    for _, row in canopus_annotations.iterrows():
                        ...
                        canopus_annotation_id = rdflib.term.URIRef(
                            kg_uri + "canopus_" + usi
                        )
                    ...
                    for _, row in canopus_annotations.iterrows():
                        ...
                        g.add(
                            (
                                ...
                                ns_kg.has_canopus_npc_superclass_prob,
                                rdflib.term.Literal(
                                    row["NPC#superclass Probability"],
                                    datatype=XSD.float,
                                ),
                            )
                        )
