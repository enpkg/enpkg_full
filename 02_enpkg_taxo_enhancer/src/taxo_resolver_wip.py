...
def taxonomic_name_resolution_service_lookup(
    species: str, path_to_results_folders: str, project_name: str
):
    """Fetches the taxonomic information for a given species name using the OpenTree Taxonomic Name Resolution Service.
...
def taxa_lineage_appender_wip(
    ...
    merged_df = df_species_tnrs_matched.drop_duplicates(
    ...
    ott_resolved = [OT.taxon_info(ott, include_lineage=True).response_dict for ott in ott_list]
