...
from src.classes.abstract_msoutput import MgfMSOutput
...
mgf_ms_output = MgfMSOutput(ms_output_name="dbgi_000065_01_01", ms_output_type="mgf", ms_output_polarity="positive", mgf_type="mzmine", spectrum_list=spectra_query)
...
ms_network = generate_mn(mgf_ms_output.get_spectrum_list(), 0.1, 0.7, 15, 10)
